...
from requirement_extraction import extract_requirements_from_pdf  # ⬅️ FIX: Extract only from one file
...
# ==============================
# 7️⃣ EXTRACT REQUIREMENTS (ONLY FROM UPLOADED FILE)
# ==============================
print("🔍 Extracting requirements...")
try:
    extracted_data = extract_requirements_from_pdf(pdf_path)  # ⬅️ FIX: Only process the uploaded file
except Exception as e:
